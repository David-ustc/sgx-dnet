...
static sgx_status_t SGX_CDECL sgx_ecall_trainer(void* pms)
{
	...
	data* _tmp_training_data = ms->ms_training_data;



	ecall_trainer(_tmp_sections, _tmp_training_data, ms->ms_pmem);
...
static sgx_status_t SGX_CDECL sgx_ecall_tester(void* pms)
{
	...
	sgx_status_t status = SGX_SUCCESS;
	list* _tmp_sections = ms->ms_sections;
	data* _tmp_test_data = ms->ms_test_data;



	ecall_tester(_tmp_sections, _tmp_test_data, ms->ms_pmem);
